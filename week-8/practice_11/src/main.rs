fn main() {
    ...
    //this means the slice starts from index 0 and goes upto index 3 (exclusive)
    println!("Index 0 to index 3 sliced = {:?}", slice2);

    //omit the end index
    let slice3 = &numbers[2..];
    //this means the slice starts from index 2 and goes upto index 5 (exclusive)
    println!("Index 2 to index 5 sliced = {:?}", slice3);

    //omit the start and the end index
    let slice4 = &numbers[..];
    //this means the slice starts from index 0 and goes upto index 5 (exclusive)
